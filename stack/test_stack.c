...
#define TEST(TYPE)                                                                                                \
        static int test_##TYPE(bds_stack_t *stack)                                                                \
        {                                                                                                         \
                bds_stack_destruct(stack);                                                                        \
                bds_stack_construct(stack, sizeof(TYPE), noop_dtor);                                              \
                                                                                                                  \
...
int main()
{
        ...
        bds_stack_construct(&stack, 1, noop_dtor);
        ...
        bds_stack_t *stack_ptr = bds_stack_create(1, noop_dtor);
