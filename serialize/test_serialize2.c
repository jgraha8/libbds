...
size_t get_bounds_len(struct data *object) { return object->num_dims * sizeof(*object->bounds); }
size_t get_c_idx_len(struct data *object) { return object->num_dims * sizeof(*object->c_idx); }

struct bds_object_member data_members[] = {
    BDS_OBJECT_MEMBER(struct data, num_dims, BDS_OBJECT_DATA, NULL),
    BDS_OBJECT_MEMBER(struct data, bounds, BDS_OBJECT_PTR_DATA, (void *)get_bounds_len),
    BDS_OBJECT_MEMBER(struct data, c_idx, BDS_OBJECT_PTR_DATA, (void *)get_c_idx_len)};
