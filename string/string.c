...
#define BDS_STRING_REMOVE_SUBSTR(N, S, C)                                                                         \
        C *bds_##N##_remove_substr(C *str, const C *substr)                                                       \
        {                                                                                                         \
                if (!bds_##N##_contains(str, substr)) {                                                           \
                        return str;                                                                               \
                }                                                                                                 \
                size_t substr_len = S##len(substr);                                                               \
                C *s              = str;                                                                          \
                while ((s = bds_##N##_find(s, substr))) {                                                         \
                        C *r = s + substr_len;                                                                    \
...
F_WSTRING(BDS_STRING_REMOVE_SUBSTR);
